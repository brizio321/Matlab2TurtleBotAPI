classdef ROSTalker4Simulation
    %ROSTalker4Simulation Implements MATLAB communication methods from/to 
    %ROS network for a simulated TurtleBot. The difference with ROSTalker
    %class is just the number (and type) of publishers and subscribers
    %available.
    ...
    %Public methods.
    methods
        function obj = ROSTalker4Simulation(model)
    ...
    methods(Sealed)
        function msg = readOdometry(obj, varargin)
            ...
            msg = ROSTalker4Simulation.readMsg(obj.subscriber.odometry, varargin);
        end
        ...
        function msg = readScan(obj, varargin)
            ...
            %Scan utility class.
            %Optionally, specify a timeout to read the message.
            msg = ROSTalker4Simulation.readMsg(obj.subscriber.scan, varargin);
        end
        ...
        function msg = readImu(obj, varargin)
            ...
            %Imu utility class.
            %Optionally, specify a timeout to read the message.
            msg = ROSTalker4Simulation.readMsg(obj.subscriber.imu, varargin);
        end
        ...
        function msg = readCoordinateTf(obj, varargin)
            ...
            %Optionally, specify a timeout to read the message.
            msg = ROSTalker4Simulation.readMsg(obj.subscriber.tf, varargin);
        end
    end
